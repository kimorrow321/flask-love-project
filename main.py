...
def page2():
    return render_page('''
        <p><b>disini aku mau ngutarain perasaan ku dan kamu juga tapi lewat yang aku kerjakan ini,
        <br> kesannya biar ga boring jadinya aku bikin ini dehhh<br>
        cuman maaf ya be kalo jelek, im tryinggg my best to make it huhu
        <br>tadi tu ya sebenernya program nya uda jad duluan cuman aku revisi ulang be<br>karena background nya
        dinosaurus wkwkw <br><b>aku pilih sincan biar sesuai kesukaanmu!</br>
    ''', 2)
...
def page8():
    return render_page('''
        <div class="closing-box">
            <p>
                oh iya saat kita conversation malam hari kemarin kemarin,<br>
                ...
                tapi rasanya lebih ngena kalo aku gagal dan gabisa bawa kamu keluar dari zona itu.
            </p>
        </div>
    ''', 8)
...
def page9():
    return render_template_string(f'''
        ...
        <body>
            ...
            <div class="closing-box">
                <p>
                    makasi yaa be udah mau baca semuanya sampai akhir <br><br>
                    aku tau isinya banyak dan panjang, jujur sampe aku bingung sama program yang kubuat sendiri<br><br>
                    kalo kamu udah baca semuanya dan mau nutup halamannya,<br>
                    kamu bisa klik tombol di bawah ini yaa 🫶
                </p>
                <form action="/goodbye">
